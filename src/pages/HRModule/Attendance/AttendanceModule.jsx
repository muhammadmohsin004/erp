...
const AttendanceModule = () => {
  ...
  const handleCheckIn = async () => {
    try {
      ...
      setCheckInData({ employeeId: "", location: "", notes: "" });
      loadAttendances();
    } catch (error) {
  ...
  const handleCheckOut = async () => {
    try {
      ...
      setCheckOutData({ employeeId: "", location: "", notes: "" });
      loadAttendances();
    } catch (error) {
  ...
  const isCheckInFormValid = () => {
    return (
      checkInData.employeeId && String(checkInData.employeeId).trim() !== ""
    );
  };

  const isCheckOutFormValid = () => {
    return (
      checkOutData.employeeId && String(checkOutData.employeeId).trim() !== ""
    );
  };
    ...
    >
      <Container className="py-8">
        ...
        <Modall
          ...
          okButtonDisabled={isProcessing || !isCheckInFormValid()}
          body={
            <div className="space-y-4">
              <div>
                ...
                <EmployeeSelect
                  employees={employees}
                  selectedEmployeeId={checkInData.employeeId}
                  onEmployeeChange={(value) =>
                    setCheckInData((prev) => ({
                      ...prev,
                      employeeId: value,
          ...
          body={
            <div className="space-y-4">
              <div>
                ...
                <EmployeeSelect
                  employees={employees}
                  selectedEmployeeId={checkOutData.employeeId}
                  onEmployeeChange={(value) =>
