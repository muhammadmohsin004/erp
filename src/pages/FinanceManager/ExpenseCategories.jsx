...
//       color:
//         cat.Color || `#${Math.floor(Math.random() * 16777215).toString(16)}`,
//     }));
...
//       TotalExpenses: mockBreakdown.reduce(
...
//   const categories = expenseCategories?.$values || [];
...
//           subHeading="Manage and organize your expense categories"
//         />
...
//                 Math.random() * category.BudgetLimit * 1.2
//               ); // Mock spent amount
...
//                   setCategoryForm({
//                     ...categoryForm,
//                     AllowOverBudget: e.target.checked,
//                   })
//                 }
//                 errors={{}}
//               />
...
//                           className="w-4 h-4 rounded-full"
//                           style={{
//                             backgroundColor: currentExpenseCategory.Color,
//                           }}
//                         />
//                         <span className="font-medium">
//                           {currentExpenseCategory.Name}
//                         </span>
//                       </div>
...
//                         <span>
//                           Status:{" "}
//                           {getStatusBadge(currentExpenseCategory.IsActive)}
//                         </span>
//                         <span>
//                           Order: {currentExpenseCategory.DisplayOrder}
//                         </span>
//                       </div>
...
//                               $
//                               {currentExpenseCategory.BudgetLimit.toLocaleString()}
//                             </span>
//                           </span>
//                         </div>
//                       )}
...
//                           $
//                           {categoryStatistics?.TotalExpenses?.toLocaleString() ||
//                             "0"}
//                         </span>
//                       </div>
//                       <div className="flex justify-between">
...
//                         </span>
//                         <span className="font-semibold">
//                           {categoryStatistics?.ExpenseCount || 0}
//                         </span>
//                       </div>
//                       <div className="flex justify-between">
//                         <span className="text-sm text-gray-600">
...
//                         <span className="font-semibold">
//                           $
//                           {categoryStatistics?.AverageExpense?.toLocaleString() ||
//                             "0"}
//                         </span>
//                       </div>
//                     </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
          ...
          <SelectBox
            ...
            handleChange={(e) => {
              ...
              filterExpenseCategoriesByStatus(e.target.value === "active");
            }}
            optionList={statusOptions}
            width="w-full"
          />
