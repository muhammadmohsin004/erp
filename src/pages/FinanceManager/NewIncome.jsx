...
const NewIncome = () => {
  ...
  const translations = {
    ...
    "Failed to create income":
      language === "ar" ? "فشل في إنشاء الدخل" : "Failed to create income",
    "Failed to update income":
      language === "ar" ? "فشل في تحديث الدخل" : "Failed to update income",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        isEditing
          ? translations["Failed to update income"]
          : translations["Failed to create income"]
      );
    } finally {
