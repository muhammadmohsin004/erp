...
const CompaniesManagement = () => {
    ...
    const generatePaginationItems = () => {
        ...
        if (totalPages <= maxVisiblePages) {
            ...
            if (currentPage > 3) {
                items.push(
                    <span key="start-ellipsis" className="px-3 py-2 text-sm text-gray-500 border border-gray-300 bg-white">
                        ...
                    </span>
                );
            }
            ...
            if (currentPage < totalPages - 2) {
                items.push(
                    <span key="end-ellipsis" className="px-3 py-2 text-sm text-gray-500 border border-gray-300 bg-white">
                        ...
                    </span>
                );
            }
                                                        ...
                                                        <div className="relative">
                                                            <button
                                                                onClick={() => setShowActionDropdown(
                                                                    showActionDropdown === company.id ? null : company.id
                                                                )}
